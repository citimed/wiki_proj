...
-- NOTE   : процесс после обработки ПТО 
-- RELEASE: 06.02.2023 machok
-- RELEASE: 18.03.2023 star - доработка
-- release: 16.05.2023 machok - проверка прихода товара Блок 5
-- RELEASE: 23.06.2023 star - фикс создания связанного перемещения (блок 4)
-- RELEASE: 15.07.2023 star - rename for block 5
-- RELEASE: 10.01.2024 star - проверка и обновление папки перенесено в before
-- RELEASE: 30.09.2024 star - Обработки кода мориона, кода поставщика, УКТЗЭД и штрих-кода
--                            (через вызов CM_GIN_UPDATE_PLU)
-- RELEASE: 26.10.2025 star - замена очередности переоценки и закрытия заказов поставщикам
-- RELEASE: 06.05.2025 star - расчет средней скользящей учетной цены для артикулов в ПТО
--
---------------------------------------------------------------------
